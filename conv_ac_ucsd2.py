...
if(nocl):
    ae_model.fit_model_ae_chaps_nocloss(verbose=1, earlystopping=True, patience=60, n_chapters=n_chapters,
                                        n_train=ntrain, reduce_lr=True, patience_lr=20, factor=1.25)


else:
    ae_model.fit_model_ae_chaps(verbose=1,n_initial_chapters=nic,earlystopping=True,patience=60,n_chapters=n_chapters,
                            n_train=ntrain, reduce_lr = True, patience_lr=20 , factor=1.25)
